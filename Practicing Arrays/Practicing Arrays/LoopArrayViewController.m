...
#import "LoopArrayViewController.h"

@interface LoopArrayViewController ()

@end

@implementation LoopArrayViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.youtube.com/watch?v=J2k8_8SQimk"];
