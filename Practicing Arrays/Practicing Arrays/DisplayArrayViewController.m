...
#import "DisplayArrayViewController.h"

@interface DisplayArrayViewController ()

@end

@implementation DisplayArrayViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.youtube.com/watch?v=L06uGnF4IpY"];
